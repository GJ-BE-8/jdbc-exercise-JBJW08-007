...
public class BankServiceImpl implements BankService {
    ...
    public boolean depositAccount(Connection connection, long accountNumber, long amount){
        ...
        int count = accountRepository.deposit(connection, accountNumber, amount);
        return count > 0;
    }
    ...
    public boolean withdrawAccount(Connection connection, long accountNumber, long amount){
        ...
        Optional<Account> account_optional = accountRepository.findByAccountNumber(connection, accountNumber);
        ...
        int count = accountRepository.withdraw(connection, accountNumber, amount);
        return count > 0;
    }
    ...
    public void transferAmount(Connection connection, long accountNumberFrom, long accountNumberTo, long amount){
        ...
        if(!accountFrom.get().isWithdraw(amount)){
